 ...
 * [xpo.yml](xpo.yml)
     * Determines how your purl.obolibrary.org/obo/xpo/ redirects will be handled
     ...
     * Paste in the contents of [xpo.yml](xpo.yml)
 ...
 * [xpo.md](xpo.md)
     ...
     * Paste in the contents of [xpo.md](xpo.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
